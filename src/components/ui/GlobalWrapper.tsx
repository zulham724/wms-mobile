...
import ModalStartScanner from "@components/common/Modal/ModalStartScanner";
...
const GlobalWrapper = ({
  ...
  const navigationState: NavigationStateInterface = useSelector((state: any) => state.navigation);
