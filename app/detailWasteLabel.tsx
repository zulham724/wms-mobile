...
const DetailWasteLabelScreen: React.FC = () => {
          ...
          <View className="bg-white p-4 rounded-b-lg">
            ...
            <View className="py-3 border-b border-gray-200">
              <View className="flex-row items-center justify-between">
                <TouchableOpacity
                  className="bg-[#08ABDE] px-5 py-2 rounded-md"
            ...
            {/* Bin Number Input Section - Improved */}
            <View className="mt-4">
              ...
              <View className="flex-row justify-between mt-2">
                <TouchableOpacity
                  className="bg-transparent px-4 py-2 rounded-md border-[#08ABDE] border-2"
                  onPress={() => console.log("Request Manual")}
                >
                  <Text className="font-medium text-[#08ABDE]">Request Manual</Text>
                </TouchableOpacity>
                
                <TouchableOpacity
                  className="bg-[#08ABDE] px-4 py-2 rounded-md"
  ...
  return (
    <View className="flex-1 bg-[#EFF1F4]">
      {/* Header */}
      <View className="pt-6 pb-4 px-4 flex-row items-center relative">
        <TouchableOpacity
          ...
          <View className="flex-row">
            ...
            >
              <Ionicons
                name="wifi"
                size={18}
                color={activeTab === "internet" ? "#08ABDE" : "#6B7280"}
              />
              <Text
                className={`ml-2 font-medium ${
                  activeTab === "internet" ? "text-[#08ABDE]" : "text-gray-500"
                }`}
              >
                Internet
              </Text>
            ...
            >
              <Ionicons
                name="bluetooth"
                size={18}
                color={activeTab === "bluetooth" ? "#08ABDE" : "#6B7280"}
              />
              <Text
                className={`ml-2 font-medium ${
                  activeTab === "bluetooth" ? "text-[#08ABDE]" : "text-gray-500"
                }`}
              >
                Bluetooth
              </Text>
...
export default DetailWasteLabelScreen;